...
class LoggerTraitTest extends TestCase
{
     ...
     * @throws DependencyException
     */
    public function testInitLoggerFallsBackToDefaultServiceWhenUseDefaultIsTrue(): void
    {
        // No usable logger in $init and useDefault left to true:
        // the trait must resolve LoggerInterface::class from the container.
        $this->container->set( LoggerInterface::class , $this->logger ) ;

        $this->testObj->initializeLogger( null , $this->container ) ;
